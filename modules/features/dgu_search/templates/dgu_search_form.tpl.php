  ...
  <div class="clearfix dgu-equal-height" data-selector=".auto-height">
    <div class="left">
      <div class="left-inner auto-height form-search">
        ...
        <form action="<?php print $form['#action']?>" method="post" id="<?php print $form['#form_id']?>" >
            <input class="form-control" type="text" name="<?php print $form['search_block_form']['#name'] ?>" value="<?php if(!empty($form['keyword']['#value']))print $form['keyword']['#value']?>" results="0" placeholder="<?php print t('Search ...')?>">
        ...
        <span class="search-all-label"><?php print t("Click search icon to see all content in this category")?></span>
        <?php endif; ?>
      </div>
    </div>
    ...
    <div class="right">
      <div class="right-inner auto-height">
        ...
        <div class="result-count-footer result-count-type"><?php print t("results")?>
